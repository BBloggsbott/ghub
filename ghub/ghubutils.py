...
class GHub(object):
    ...
    client_secret = "1931c8c29d363fb5bbe9c3e885de8a8036790bcb"  # client secret for GitHub's OAuth
    def __init__(self, reauthorize = False):
        ...
        """
        self.data_path = Path.home() / ".ghub"  # Path to all the files to locally save info for ghub
